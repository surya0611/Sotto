  ...
  },
  {
    ...
    render: () => (
      <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' }}>
          <div style={{ fontSize: '12px', color: '#fff', fontFamily: 'monospace', letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>15 creators downloaded the <strong style={{ fontWeight: 800 }}>UI Kit</strong></div>
          <div style={{ fontSize: '11px', color: '#B4D496', fontFamily: 'monospace' }}>5 mins ago</div>
        </div>
      </div>
    ),
    style: {
