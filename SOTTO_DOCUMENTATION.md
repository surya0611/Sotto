...
| `source` | TEXT | `shopify`, `razorpay`, `typeform`, `google_forms`, `sotto_pixel`, `custom`, `easebuzz`, `cratejoy`, `3dcart`, `magento`, `lightspeed`, `bigcommerce`, `ecwid`, `thrivecart`, `squarespace`, `jumpseller`, `bigcartel`, `woocommerce`, `instamojo`, `cashfree`, `payu`, `dukaan`, `stripe` |
